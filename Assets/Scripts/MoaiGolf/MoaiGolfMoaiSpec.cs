    ...
    public readonly struct MoaiGolfMoaiSpec
    {
        ...
        public static MoaiGolfMoaiSpec Get(MoaiGolfMoaiKind kind)
        {
            ...
            return kind switch
            {
                ...
                MoaiGolfMoaiKind.Macho => new MoaiGolfMoaiSpec(kind, "Textures/moai4", new Vector2(1.35f, 1.2f), new Vector2(1.05f, 1.0f), 2.025f, 0.25f, 0.62f, 0f),
                MoaiGolfMoaiKind.Snowman => new MoaiGolfMoaiSpec(kind, "Textures/moai3", new Vector2(1.15f, 1.25f), new Vector2(0.9f, 1.1f), 0.896f, 0.58f, 0.18f, 0f),
